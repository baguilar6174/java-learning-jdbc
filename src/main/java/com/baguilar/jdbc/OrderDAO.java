...
public class OrderDAO extends DataAccessObject<Order> {
    ...
    private static final String GET_FOR_CUSTOMER = "SELECT * from get_orders_by_customer(?)";
    ...
    public List<Order> getOrdersForCustomer(long customerId) {
        ...
        try (PreparedStatement preparedStatement = this.connection.prepareStatement(GET_FOR_CUSTOMER)) {
